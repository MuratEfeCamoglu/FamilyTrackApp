...
@injectable
class AddPersonUseCase implements UseCase<Person, AddPersonParams> {
  AddPersonUseCase(this._repository);
  final PersonRepository _repository;

  @override
  Future<Either<Failure, Person>> call(AddPersonParams params) =>
      _repository.addPerson(userId: params.userId, person: params.person);
}

class AddPersonParams extends Equatable {
  const AddPersonParams({required this.userId, required this.person});
  final String userId;
  final Person person;
  @override
